...
# Android 17 QPR2 inserted cgroup_uid between uid and gid
fas_c_qpr2 = ForkAndSpec('c_qpr2', [uid, cgroup_uid, gid, gids, runtime_flags, rlimits, mount_external,
...
with open('jni_hooks.hpp', 'w') as f:
    ...
    f.write(gen_jni_def('zygote', [
        fas_l, fas_o, fas_p, fas_q_alt, fas_r, fas_u, fas_c, fas_c_qpr2, fas_samsung_m, fas_samsung_n,
        fas_samsung_o, fas_samsung_p, fas_samsung_b, fas_grapheneos_u, fas_grapheneos_17, spec_q,
        spec_q_alt, spec_r, spec_u, spec_c_qpr2, spec_samsung_q, spec_grapheneos_u, spec_grapheneos_17,
