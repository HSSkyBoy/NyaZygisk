...
androidComponents.onVariants { variant ->
    ...
    val prepareModuleFilesTask = task<Sync>("prepareModuleFiles$variantCapped") {
        ...
        from("$projectDir/src") {
            exclude("module.prop", "customize.sh", "post-fs-data.sh", "late-load.sh", "zygisk-init.sh", "service.sh", "uninstall.sh", "zygisk-ctl.sh")
        ...
        from("$projectDir/src") {
            include("customize.sh", "post-fs-data.sh", "late-load.sh", "zygisk-init.sh", "service.sh", "uninstall.sh", "zygisk-ctl.sh")
            val tokens = mapOf(
